...
int main() {
  ...
  while(true) {
    ...
    if(strcmp(input, "ADD") == 0) {
      // basic information that all types of digital media have in common
      char typeOfMedia[10];
      char title[100];
      int year;
      
      // enter type and information of the media they want to add
    ...
    } // if user wants to search through all media
    else if(strcmp(input, "SEARCH") == 0) {
      // ask user if they want to search by title or year
      char searchType[6];
	...
	// ask user to enter the title they are looking for
